          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 text-readable px-4">
                Soluciones profesionales para hogares y negocios en Miami
              </p>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <ScrollReveal>
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto text-readable px-4">
              Contáctanos y te ayudaremos a encontrar la solución perfecta para tus necesidades de limpieza.
            </p>
          </ScrollReveal>
          <a
            href="/contacto"
